...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("get-model-table-row-indices", "/models/:mid/artifacts/:aid/table-row-indices", slycat.web.server.handlers.get_model_table_row_indices, conditions={"method" : ["GET"]})
