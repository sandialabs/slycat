...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("get-model-table-unsorted-indices", "/models/:mid/artifacts/:aid/table-unsorted-indices", slycat.web.server.handlers.get_model_table_unsorted_indices, conditions={"method" : ["GET"]})
