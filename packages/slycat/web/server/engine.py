...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("put-model-parameter", "/models/:mid/parameter/:name", slycat.web.server.handlers.put_model_parameter, conditions={"method" : ["PUT"]})
  dispatcher.connect("post-model-array-set", "/models/:mid/array-set/:name", slycat.web.server.handlers.post_model_array_set, conditions={"method" : ["POST"]})
#  dispatcher.connect("post-model-create-array", "/workers/:wid/model/create-array", slycat.web.server.handlers.post_worker_endpoint("post_model_create_array"), conditions={"method" : ["POST"]})
#  dispatcher.connect("post-model-store-array-attribute", "/workers/:wid/model/store-array-attribute", slycat.web.server.handlers.post_worker_endpoint("post_model_store_array_attribute"), conditions={"method" : ["POST"]})
  ...
  dispatcher.connect("get-model-table-metadata", "/models/:mid/artifacts/:aid/tables/:array/metadata", slycat.web.server.handlers.get_model_table_metadata, conditions={"method" : ["GET"]})
  dispatcher.connect("get-model-table-chunk", "/models/:mid/artifacts/:aid/tables/:array/chunk", slycat.web.server.handlers.get_model_table_chunk, conditions={"method" : ["GET"]})
  dispatcher.connect("get-model-table-sorted-indices", "/models/:mid/artifacts/:aid/tables/:array/sorted-indices", slycat.web.server.handlers.get_model_table_sorted_indices, conditions={"method" : ["GET"]})
  dispatcher.connect("get-model-table-unsorted-indices", "/models/:mid/artifacts/:aid/tables/:array/unsorted-indices", slycat.web.server.handlers.get_model_table_unsorted_indices, conditions={"method" : ["GET"]})
  ...
  dispatcher.connect("post-worker-model-start-array-set", "/workers/:wid/model/start-array-set", slycat.web.server.handlers.post_worker_endpoint("post_model_start_array_set"), conditions={"method" : ["POST"]})
  dispatcher.connect("post-worker-model-create-array", "/workers/:wid/model/create-array", slycat.web.server.handlers.post_worker_endpoint("post_model_create_array"), conditions={"method" : ["POST"]})
  dispatcher.connect("post-worker-model-store-array-attribute", "/workers/:wid/model/store-array-attribute", slycat.web.server.handlers.post_worker_endpoint("post_model_store_array_attribute"), conditions={"method" : ["POST"]})
  dispatcher.connect("post-worker-model-finish-array-set", "/workers/:wid/model/finish-array-set", slycat.web.server.handlers.post_worker_endpoint("post_model_finish_array_set"), conditions={"method" : ["POST"]})
