...
def start(root_path, config_file):
  ...
  dispatcher.connect("get-project-csv-data", "/projects/:pid/data/:file_key/parser/:parser/mid/:mid/aids/:aids", slycat.web.server.handlers.get_project_csv_data, conditions={"method": ["GET"]})
