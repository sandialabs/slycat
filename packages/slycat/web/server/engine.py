...
def start(root_path, config_file):
  ...
  dispatcher.connect("get-agent-video-status", "/agents/:sid/video/:vsid/status", slycat.web.server.handlers.get_agent_video_status, conditions={"method" : ["GET"]})
  dispatcher.connect("get-agent-video", "/agents/:sid/video/:vsid", slycat.web.server.handlers.get_agent_video, conditions={"method" : ["GET"]})
  ...
  dispatcher.connect("post-agent-video", "/agents/:sid/video", slycat.web.server.handlers.post_agent_video, conditions={"method" : ["POST"]})
