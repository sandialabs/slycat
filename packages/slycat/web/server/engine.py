...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("post-model-array-set-array", "/models/:mid/array-set/:name/array/:array", slycat.web.server.handlers.post_model_array_set_array, conditions={"method" : ["POST"]})
  dispatcher.connect("put-model-array-set-array-attribute", "/models/:mid/array-set/:name/array/:array/attribute/:attribute", slycat.web.server.handlers.put_model_array_set_array_attribute, conditions={"method" : ["PUT"]})
