...
def start(root_path, config_file):
  ...
  dispatcher.connect("get-session-status", "/remotes/:hostname/:jid/get-remote-job-status", slycat.web.server.handlers.get_remote_job_status, conditions={"method": ["GET"]})
