...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("post-model-array-set-array-attribute", "/models/:mid/array-sets/:name/arrays/:array/attributes/:attribute", slycat.web.server.handlers.post_model_array_set_array_attribute, conditions={"method" : ["POST"]})
