...
def start(root_path, config_file):
  ...
  dispatcher.connect("create-project-data-from-pid", "/projects/:pid/data/:file/aids/:aid", slycat.web.server.handlers.create_project_data_from_pid, conditions={"method": ["POST"]})
