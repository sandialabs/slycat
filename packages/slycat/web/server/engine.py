...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("put-model-array", "/models/:mid/array-sets/:name/arrays/:array", slycat.web.server.handlers.put_model_array, conditions={"method" : ["PUT"]})
  dispatcher.connect("put-model-array-set-data", "/models/:mid/array-sets/:name/data", slycat.web.server.handlers.put_model_array_set_data, conditions={"method" : ["PUT"]})
  dispatcher.connect("put-model-array-attribute-data", "/models/:mid/array-sets/:name/arrays/:array/attributes/:attribute/data", slycat.web.server.handlers.put_model_array_attribute_data, conditions={"method" : ["PUT"]})
