...
def start(root_path, config_file):
  ...
  dispatcher.connect("get-model-wizard-resource", "/resources/wizards/:wtype/{resource:.*}", slycat.web.server.handlers.get_model_wizard_resource, conditions={"method" : ["GET"]})
