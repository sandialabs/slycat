...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("put-model-array-set-array-attribute", "/models/:mid/array-sets/:name/arrays/:array/attributes/:attribute", slycat.web.server.handlers.put_model_array_set_array_attribute, conditions={"method" : ["PUT"]})
