...
def start(config_file="config.ini"):
  ...
  dispatcher.connect("put-model-array-set-array", "/models/:mid/array-sets/:name/arrays/:array", slycat.web.server.handlers.put_model_array_set_array, conditions={"method" : ["PUT"]})
