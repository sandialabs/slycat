...
for plugin in ["couchdb-availability", "couchdb-request-times", "scidb-availability", "slycat-availability", "slycat-memory", "slycat-threads", "slycat-requests"]:
...
for conf in ["scidb.conf", "slycat-requests.conf"]:
