...
for plugin in ["couchdb-availability", "couchdb-request-times", "slycat-availability", "slycat-memory", "slycat-threads", "slycat-requests"]:
...
for conf in ["slycat-requests.conf"]:
