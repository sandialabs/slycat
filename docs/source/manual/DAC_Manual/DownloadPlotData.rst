...
close the dialog, reset the zoom, and push the export plot button again.  Second, if the plots have been filtered (see :ref:`FilterPlots` and 
:ref:`TableFiltering`), then only the plots displayed (selected *and* filtered) will be exported.  If you want to export non-filtered plots 
you will have to close the dialog, clear the filters and push the export plot button again.  These caveats apply to both the “Save All Plots” 
