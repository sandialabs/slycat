DELETE Project Data In Model Data
=================================

.. http:delete:: /api/projects/data/(did)/model/(mid)
  ...
  :status 204: Project data removed from model.

  **Sample Request**

  .. sourcecode:: http

    DELETE /api/projects/data/1j2j34539570439cb3703c0f8806158e/model/8b8122539570439cb3703c0f8806158e HTTP/1.1
    Accept: */*
  ...
  **Sample Response**
  ...
  .. sourcecode:: http
    ...
    HTTP/1.1 204 Project data removed from model.
