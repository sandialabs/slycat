...
kernel = scipy.signal.boxcar(1001)

pyplot.figure()
pyplot.plot(scipy.signal.fftconvolve(create, kernel / kernel.sum()), color="gray")
...
pyplot.figure()
pyplot.plot(scipy.signal.fftconvolve(write, kernel / kernel.sum()), color="gray")
...
pyplot.figure()
pyplot.plot(scipy.signal.fftconvolve(read, kernel / kernel.sum()), color="gray")
