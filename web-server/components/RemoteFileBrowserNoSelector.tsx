 ...
 * @export
 * @interface RemoteFileBrowserNoSelectorProps
 */
export interface RemoteFileBrowserNoSelectorProps { 
  hostname: string
 ...
 * @export
 * @interface RemoteFileBrowserNoSelectorState
 */
export interface RemoteFileBrowserNoSelectorState {
  path:string
  pathInput:string
  persistenceId:string
 ...
 *
 * @export
 * @class RemoteFileBrowserNoSelector
 * @extends {React.Component<RemoteFileBrowserNoSelectorProps, RemoteFileBrowserNoSelectorState>}
 */
export default class RemoteFileBrowserNoSelector extends React.Component<RemoteFileBrowserNoSelectorProps, RemoteFileBrowserNoSelectorState> {
    public constructor(props:RemoteFileBrowserNoSelectorProps) {
      super(props)
      this.state = {
        path:"/",
        pathInput: "/",
     ...
     * @private
     * @memberof RemoteFileBrowserNoSelector
     */
