...
export default class VariableRanges extends React.Component {
  ...
  validateMinAndMax = (name, inputString, previousState, props) => {
    ...
    return {
      ...
      [`${oppositeName}_valid`]: this.validateMinOrMax(
        oppositeInput,
        oppositeNum,
        !min,
        oppositeCompare,
        ...
        <table className="table table-striped table-hover table-sm table-borderless">
          <thead>
            <tr>
              ...
              <th scope="col" className={`align-top text-nowrap px-2 ${this.text_align}`}>
                {this.props.inputLabel} Min
              </th>
              <th scope="col" className={`align-top text-nowrap px-2 ${this.text_align}`} />
              <th scope="col" className={`align-top text-nowrap px-2 ${this.text_align}`}>
                {this.props.inputLabel} Max
              </th>
              <th scope="col" className={`align-top text-nowrap px-2 ${this.text_align}`}>
                Data Max
              </th>
  ...
  render() {
    ...
    return (
      <tr key={this.props.index}>
        <th scope="row" className="align-middle variable-name px-2">
          {this.props.label}
        </th>
        <td className={`align-middle px-2 ${this.props.text_align} data-min`}>
        ...
        <td className={`align-middle ${this.props.text_align} axis-max axis-input`}>
          <div className="input-group input-group-sm">
            <input
              type="number"
