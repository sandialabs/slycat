...
define(["slycat-server-root", "slycat-web-client", "slycat-dialog", "slycat-bookmark-manager", "knockout", "knockout-mapping", "slycat-file-uploader-factory"], function(server_root, client, dialog, bookmark_manager, ko, mapping, fileUploader)
{
