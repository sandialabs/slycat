    ...
    success: function (result) {
      ...
      bookmarker.getState(function (state) {
        ...
        highlighted_simulations =
          bookmark["simulation-selection"] !== undefined ? bookmark["simulation-selection"] : [];
        ...
        pinned_simulations =
          bookmark["pinned_simulations"] !== undefined ? bookmark["pinned_simulations"] : [];
