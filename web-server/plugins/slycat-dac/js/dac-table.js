  ...
  dialog.dialog({
    ...
    callback: function (button) {
      ...
      if (typeof button !== "undefined") {
        if (button.label == "Save All Visible") write_data_table(all_sel, defaultFilename);
        else if (button.label == "Save Selected Visible") write_data_table(sel, defaultFilename);
      }
    },
  });
}
