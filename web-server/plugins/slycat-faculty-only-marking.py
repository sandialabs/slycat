def register_slycat_plugin(context):
  ...
  page = """<div style="background:white; border-top:2px solid black; border-bottom:2px solid black; color:red; font-weight:bold; padding:5px; text-align:center;">FACULTY ONLY</div>"""
