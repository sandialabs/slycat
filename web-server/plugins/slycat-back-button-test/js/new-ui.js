...
define(["slycat-server-root", "slycat-web-client", "slycat-dialog", "slycat-markings", "knockout", "knockout-mapping", "slycat-file-uploader-factory"], function(server_root, client, dialog, markings, ko, mapping, fileUploader)
{
