...
$.widget("cca.barplot",
{
  ...
  _create: function ()
  {
    ...
    for(var i = 0; i != inputs.length; ++i)
    {
      ...
      //   // var barplotCellWrapper = $('<div class="wrapper" />').appendTo(barplotCell);
      //   // var barplotCellNegativeSpacer = $('<div class="negativeSpacer spacer" />').appendTo(barplotCellWrapper);
      //   // var barplotCellNegative = $('<div class="negative" />')
      //     // .css("width", negative_bar_width(x_loadings[component][i]))
      //     // .addClass(component_class(component))
      //     // .appendTo(barplotCellNegativeSpacer);
      //   // var barplotCellValue = $('<div class="barplotCellValue" />').html(Number(x_loadings[component][i]).toFixed(3)).appendTo(barplotCellWrapper);
      //   // var barplotCellPositiveSpacer = $('<div class="positiveSpacer spacer" />').appendTo(barplotCellWrapper);
      //   // var barplotCellPositive = 
      //     // $('<div class="positive" />')
      //       // .css("width", positive_bar_width(x_loadings[component][i]))
      //       // .addClass(component_class(component))
    ...
    for(var i = 0; i != outputs.length; ++i)
    {
      ...
      // {
      //   // var barplotCell = 
      //   //   $('<div class="barplotCell rowOutput">')
      //   //     .addClass('row' + (i + inputs.length) + ' col' + (component+1) + ' variable' + outputs[i]).appendTo(barplotRow);
      //   // var barplotCellWrapper = $('<div class="wrapper" />').appendTo(barplotCell);
      //   // var barplotCellNegativeSpacer = $('<div class="negativeSpacer spacer" />').appendTo(barplotCellWrapper);
      //   // var barplotCellNegative = 
      //   //   $('<div class="negative" />')
      //   //     .css("width", negative_bar_width(y_loadings[component][i]))
      //   //     .addClass(component_class(component)).appendTo(barplotCellNegativeSpacer);
      //   // var barplotCellValue = 
      //   //   $('<div class="barplotCellValue" />')
      //   //   .html(Number(y_loadings[component][i]).toFixed(3)).appendTo(barplotCellWrapper);
      //   // var barplotCellPositiveSpacer = $('<div class="positiveSpacer spacer" />').appendTo(barplotCellWrapper);
      //   // var barplotCellPositive = 
      //   //   $('<div class="positive" />')
