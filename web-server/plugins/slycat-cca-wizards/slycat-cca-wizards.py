def register_slycat_plugin(context):
  ...
  context.register_wizard("remote-cca", "Remote CCA Model", require={"project":True})
  ...
  context.register_wizard("local-cca", "Local CCA Model", require={"project":True})
  ...
  context.register_wizard("rerun-cca", "Rerun CCA Model", require={"project":True, "model":["cca"]})
