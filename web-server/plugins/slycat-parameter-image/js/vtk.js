...
import style from 'vtk.js/Examples/Applications/GeometryViewer/GeometryViewer.module.css';
import icon from 'img/slycat-brand.png';
...
// let vtkcontainer = document.createElement('div');
// var currentDiv = document.getElementById("slycat-model-content"); 
// document.body.insertBefore(vtkcontainer, currentDiv); 

// load(
//     document.getElementById("vtk"),
//   {fileURL: 'https://data.kitware.com/api/v1/item/59de9de58d777f31ac641dc5/download'}
// )

// Auto setup if no method get called within 100ms
// setTimeout(() => {
//   if (autoInit) {
//     initLocalFileLoader(document.getElementById('scatterplot-pane'));
//   }
// }, 100);
