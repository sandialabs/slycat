...
connection.put_model_array_set_data(mid, "data", array=0, attribute=0, hyperslice=[(0, 2), (0, 2)], data=m22) # A hyperslice of one attribute of one array
connection.put_model_array_set_data(mid, "data", array=0, attribute=1, data=m44) # One attribute of one array
connection.put_model_array_set_data(mid, "data", array=0, data=[m44, m44, m44]) # Every attribute of one array
connection.put_model_array_set_data(mid, "data", array=slice(1, 3), data=[m44, m44, m44, m66, m66, m66]) # Every attribute of a range of arrays
connection.put_model_array_set_data(mid, "data", array=[2, 1], attribute=[1, 0], data=[m66, m66, m44, m44]) # Multiple attributes of multiple arrays 
connection.put_model_array_set_data(mid, "data", data=[m44, m44, m44, m44, m44, m44, m66, m66, m66]) # Every attribute of every array
