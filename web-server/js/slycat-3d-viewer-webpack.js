...
import slycat3dViewer from '../templates/slycat-3d-viewer.html';
import Stats from './Stats.js';

import * as THREE from 'three';
import STLLoaderr from 'three-stl-loader';
var STLLoader = STLLoaderr(THREE);
import TrackballControls from 'three-trackballcontrols';
// Equivalent to above 4 lines using using 3 require lines
...
ko.components.register('slycat-3d-viewer', {
  viewModel: function(params) {
    ...
    new STLLoader().load(loadUri, function(geometry) {
