...
ScatterPlot.prototype.setup_labels = function() {
  ...
  if("images-selection-" + this.plot_id in layout.bookmark) {
    var self = this;
    model.get_image_column(layout.bookmark["images-selection-" + this.plot_id], function(result){ self.images = result; }, false);
  }
};
