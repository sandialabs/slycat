...
mid = connection.post_project_models(pid, "parameter-image-plus", arguments.model_name if arguments.model_name is not None else arguments.input, arguments.marking)
